...
/* harmony export */   getAllFaq: () => (/* binding */ getAllFaq),
/* harmony export */   removeFaq: () => (/* binding */ removeFaq),
/* harmony export */   updateFaq: () => (/* binding */ updateFaq)
/* harmony export */ });
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index */ "./src/http/index.js");


const createFaq = async (title, descr) => {
  const { data } = await _index__WEBPACK_IMPORTED_MODULE_0__.$host.post('api/faq/', { title, descr });
  return data;
};

const updateFaq = async (id, title, descr) => {
  const { data } = await _index__WEBPACK_IMPORTED_MODULE_0__.$host.patch('api/faq/update/' + id, { title, descr });
  return data;
};

const removeFaq = async (id) => {
  const { data } = await _index__WEBPACK_IMPORTED_MODULE_0__.$host.delete('api/faq/' + id);
  return data;
};

const getAllFaq = async () => {
  const { data } = await _index__WEBPACK_IMPORTED_MODULE_0__.$host.get('api/faq/');
  return data;
};
...
/* harmony export */   getAllService: () => (/* binding */ getAllService),
...
const createService = async (title, descr, price) => {
  const { data } = await _index__WEBPACK_IMPORTED_MODULE_0__.$host.post('api/service/', { title, descr, price });
  return data;
};

const updateService = async (id, title, descr, price) => {
  const { data } = await _index__WEBPACK_IMPORTED_MODULE_0__.$host.patch('api/service/update/' + id, { title, descr, price });
  return data;
};

const removeService = async (id) => {
  const { data } = await _index__WEBPACK_IMPORTED_MODULE_0__.$host.delete('api/service/' + id);
  return data;
};

const getAllService = async () => {
  const { data } = await _index__WEBPACK_IMPORTED_MODULE_0__.$host.get('api/service/');
  return data;
};
...
/* harmony import */ var _http_faqAPI__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../http/faqAPI */ "./src/http/faqAPI.js");
/* harmony import */ var _http_mainAPI__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../http/mainAPI */ "./src/http/mainAPI.js");
/* harmony import */ var _http_servicesAPI__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../http/servicesAPI */ "./src/http/servicesAPI.js");
/* harmony import */ var _dropDownList__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./dropDownList */ "./src/scripts/dropDownList.js");
/* harmony import */ var _dropDownList__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_dropDownList__WEBPACK_IMPORTED_MODULE_5__);
...
(0,_http_mainAPI__WEBPACK_IMPORTED_MODULE_3__.getMain)(1).then((data) => {
...
(0,_http_servicesAPI__WEBPACK_IMPORTED_MODULE_4__.getAllService)().then((data) => {
  data.forEach((item) => {
...
(0,_http_faqAPI__WEBPACK_IMPORTED_MODULE_2__.getAllFaq)()
  .then((data) => {
    data.forEach((item) => {
  ...
  .then(() => {
    ...
    (0,_dropDownList__WEBPACK_IMPORTED_MODULE_5__.animationDropList)(
      faqItems,
      faqItemsBlock,
      faqIcon,
