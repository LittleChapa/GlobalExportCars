...
/* harmony export */   creteCatalog: () => (/* binding */ creteCatalog),
/* harmony export */   getAllCatalog: () => (/* binding */ getAllCatalog),
/* harmony export */   removeCatalog: () => (/* binding */ removeCatalog),
/* harmony export */   updateCatalog: () => (/* binding */ updateCatalog)
/* harmony export */ });
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index */ "./src/http/index.js");


const creteCatalog = async (catalog) => {
  const { data } = await _index__WEBPACK_IMPORTED_MODULE_0__.$host.post('api/catalog/', catalog);
  return data;
};

const updateCatalog = async (id, catalog) => {
  const { data } = await _index__WEBPACK_IMPORTED_MODULE_0__.$host.patch('api/catalog/' + id, catalog);
  return data;
};

const removeCatalog = async (id) => {
  const { data } = await _index__WEBPACK_IMPORTED_MODULE_0__.$host.delete('api/catalog/' + id);
  return data;
};

const getAllCatalog = async () => {
  const { data } = await _index__WEBPACK_IMPORTED_MODULE_0__.$host.get('api/catalog/');
  return data;
};
...
(() => {
/*!*************************************!*\
  !*** ./src/scripts/adminCatalog.js ***!
  \*************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _http_catalogAPI__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../http/catalogAPI */ "./src/http/catalogAPI.js");
...
(0,_http_catalogAPI__WEBPACK_IMPORTED_MODULE_0__.getAllCatalog)()
  .then((data) => {
    for (let i = 0; i < data.length; i++) {
      ...
      image.src = "http://localhost:5000/" + data[i].img;
  ...
  .then(() => {
    const adminCatalogFileInput = document.querySelectorAll(
      ".admin-catalog__file-input"
    );
    const adminCatalogFormImage = document.querySelectorAll(
      ".admin-catalog__form-image-item"
    );

    console.log(adminCatalogFileInput[0]);
    console.log(adminCatalogFormImage);
    adminCatalogFileInput[0].addEventListener("change", (e) => {
      ...
      if (imageLabel) {
        ...
        reader.onload = function (event) {
          ...
          adminCatalogFormImage[0].src = event.target.result;
        };
